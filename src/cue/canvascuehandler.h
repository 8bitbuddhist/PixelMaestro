...
namespace PixelMaestro {
	class CanvasCueHandler : public CueHandler {
		public:
			...
			void draw_frame(uint8_t section_num, uint8_t overlay_num, uint16_t size_x, uint16_t size_y, bool* frame);
			void draw_frame(uint8_t section_num, uint8_t overlay_num, uint16_t size_x, uint16_t size_y, Colors::RGB* frame);
