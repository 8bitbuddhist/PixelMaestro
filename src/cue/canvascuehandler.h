...
namespace PixelMaestro {
	class CanvasCueHandler : public CueHandler {
		public:
			...
			uint8_t* draw_frame(uint8_t section_num, uint8_t layer_num, uint16_t size_x, uint16_t size_y, bool* frame);
			uint8_t* draw_frame(uint8_t section_num, uint8_t layer_num, uint16_t size_x, uint16_t size_y, Colors::RGB* frame);
			uint8_t* draw_frame(uint8_t section_num, uint8_t layer_num, uint16_t size_x, uint16_t size_y, uint8_t* frame);

			uint8_t* draw_line(uint8_t section_num, uint8_t layer_num, uint16_t origin_x, uint16_t origin_y, uint16_t target_x, uint16_t target_y);
			uint8_t* draw_line(uint8_t section_num, uint8_t layer_num, Colors::RGB color, uint16_t origin_x, uint16_t origin_y, uint16_t target_x, uint16_t target_y);
			...
			uint8_t* draw_point(uint8_t section_num, uint8_t layer_num, uint16_t x, uint16_t y);
			uint8_t* draw_point(uint8_t section_num, uint8_t layer_num, Colors::RGB color, uint16_t x, uint16_t y);
			uint8_t* draw_point(uint8_t section_num, uint8_t layer_num, uint8_t color_index, uint16_t x, uint16_t y);

			uint8_t* draw_rect(uint8_t section_num, uint8_t layer_num, uint16_t origin_x, uint16_t origin_y, uint16_t size_x, uint16_t size_y, bool fill);
			uint8_t* draw_rect(uint8_t section_num, uint8_t layer_num, Colors::RGB color, uint16_t origin_x, uint16_t origin_y, uint16_t size_x, uint16_t size_y, bool fill);
			...
			uint8_t* draw_text(uint8_t section_num, uint8_t layer_num, uint16_t origin_x, uint16_t origin_y, Font::Type font, const char* text, uint8_t num_chars);
			uint8_t* draw_text(uint8_t section_num, uint8_t layer_num, Colors::RGB color, uint16_t origin_x, uint16_t origin_y, Font::Type font, const char* text, uint8_t num_chars);
			...
			uint8_t* draw_triangle(uint8_t section_num, uint8_t layer_num, uint16_t point_a_x, uint16_t point_a_y, uint16_t point_b_x, uint16_t point_b_y, uint16_t point_c_x, uint16_t point_c_y, bool fill);
			uint8_t* draw_triangle(uint8_t section_num, uint8_t layer_num, Colors::RGB color, uint16_t point_a_x, uint16_t point_a_y, uint16_t point_b_x, uint16_t point_b_y, uint16_t point_c_x, uint16_t point_c_y, bool fill);
			...
			uint8_t* set_drawing_color(uint8_t section_num, uint8_t layer_num, Colors::RGB color);
