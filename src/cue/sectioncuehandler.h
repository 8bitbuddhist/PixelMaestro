...
namespace PixelMaestro {
	class SectionCueHandler : public CueHandler {
		public:
			...
			void set_animation(uint8_t section_num, uint8_t overlay_num, AnimationType::Type animation_type, bool preserve_cycle_index, Colors::RGB* colors, uint8_t num_colors, bool delete_old_colors = true);
