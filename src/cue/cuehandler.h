...
namespace PixelMaestro {
	...
	class CueHandler {
		...
		protected:
			...
			uint16_t start_cue(uint8_t handler_byte, uint8_t action_byte);
			uint16_t start_cue(uint8_t handler_byte, uint8_t action_byte, uint8_t section_num, uint8_t layer_num);
	};
}
