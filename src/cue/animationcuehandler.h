...
namespace PixelMaestro {
	class AnimationCueHandler : public CueHandler {
		public:
			...
			uint8_t* reset_center(uint8_t section_num, uint8_t overlay_num);
			uint8_t* set_center(uint8_t section_num, uint8_t overlay_num);
			...
			uint8_t* set_timing(uint8_t section_num, uint8_t overlay_num, uint16_t interval, uint16_t pause = 0);
