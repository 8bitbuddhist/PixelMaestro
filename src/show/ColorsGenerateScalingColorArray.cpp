...
namespace PixelMaestro {
	ColorsGenerateScalingColorArray::ColorsGenerateScalingColorArray(Colors::RGB newArray[], Colors::RGB *baseColor, Colors::RGB *targetColor, unsigned int numColors, bool reverse, unsigned long time) : Transition(time) {
	...
	ColorsGenerateScalingColorArray::ColorsGenerateScalingColorArray(Colors::RGB newArray[], Colors::RGB *baseColor, unsigned int numColors, unsigned char threshold, bool reverse, unsigned long time) : Transition(time) {
		this->new_array_ = newArray;
		this->base_color_ = baseColor;
		this->num_colors_ = numColors;
