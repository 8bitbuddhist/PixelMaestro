/*
 * BaseCanvas.cpp -Base class for drawing patterns on a Section.
 */
...
namespace PixelMaestro {
	 ...
	 */
	BaseCanvas::BaseCanvas(Section* section) {
	 ...
	 */
	void BaseCanvas::draw_circle(unsigned short origin_x, unsigned short origin_y, unsigned short radius, bool fill) {
		// (x – h)^2 + (y – k)^2 = r^2
	 ...
	 */
	void BaseCanvas::draw_line(unsigned short origin_x, unsigned short origin_y, unsigned short target_x, unsigned short target_y) {
		// Calculate slope
		float slope;
	 ...
	 * @param cursor_y Starting point y coordinate.
	 */
	void BaseCanvas::draw_point(unsigned short x, unsigned short y) {
		if (in_bounds(x, y)) {
	 ...
	 */
	void BaseCanvas::draw_rect(unsigned short origin_x, unsigned short origin_y, unsigned short size_x, unsigned short size_y, bool fill) {
		Point cursor = { origin_x, origin_y };
	 ...
	 */
	void BaseCanvas::draw_text(unsigned short origin_x, unsigned short origin_y, Font* font, const char* text) {
		Point cursor = {origin_x, origin_y};
	 ...
	 */
	void BaseCanvas::draw_triangle(unsigned short point_a_x, unsigned short point_a_y, unsigned short point_b_x, unsigned short point_b_y, unsigned short point_c_x, unsigned short point_c_y, bool fill) {
	 ...
	 */
	void BaseCanvas::erase(unsigned short x, unsigned short y) {
	 ...
	 */
	Section* BaseCanvas::get_section() {
		return section_;
	}
	 ...
	 */
	bool BaseCanvas::in_bounds(Point* point) {
	 ...
	 * @return Whether the Point is in bounds.
	 */
	bool BaseCanvas::in_bounds(unsigned short x, unsigned short y) {
	 ...
	 */
	void BaseCanvas::set_offset(signed short x, signed short y) {
		offset_x_ = x;
		offset_y_ = y;
	}
	 ...
	 */
	void BaseCanvas::set_scroll(signed short x, signed short y, bool repeat) {
		if (scroll_ == nullptr) {
	 ...
	 */
	void BaseCanvas::set_section(Section *section) {
		this->section_ = section;
		initialize_pattern();
	}
	 ...
	 */
	void BaseCanvas::update(const unsigned long& current_time) {
		if (scroll_ != nullptr) {
	 ...
	 * @param current_time The program's current runtime).
	 */
	void BaseCanvas::update_scroll(const unsigned long& current_time) {
		/*
