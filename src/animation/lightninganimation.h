...
namespace PixelMaestro {
	class LightningAnimation : public Animation {
		public:
			LightningAnimation(unsigned char num_bolts, unsigned char down_threshold = 35, unsigned char up_threshold = 65, unsigned char fork_chance_ = 20, Colors::RGB* colors = nullptr, unsigned short num_colors = 0);
		...
		private:
			...
			void draw_bolt(Section* section, Point* start, unsigned char fork_chance);
	};
}
