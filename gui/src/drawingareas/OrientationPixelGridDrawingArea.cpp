...
#include <vector>
#include "../../include/drawingareas/OrientationPixelGridDrawingArea.h"

using namespace PixelMaestro;
using namespace std;
using namespace std::chrono;

OrientationPixelGridDrawingArea::OrientationPixelGridDrawingArea(Gtk::Window* parentWindow) {
	...
	sections_[0].setColorAnimation(Section::ColorAnimations::WAVE);
...
bool OrientationPixelGridDrawingArea::on_draw(const Cairo::RefPtr<Cairo::Context>& cr) {
