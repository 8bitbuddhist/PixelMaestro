...
ColorCanvasDemo::ColorCanvasDemo(QWidget* parent, MaestroController* maestro_controller) : SimpleDrawingArea(parent, maestro_controller) {
	...
	Animation* animation = section->set_animation(AnimationType::Radial, Colors::COLORWHEEL, 12);
	...
	canvas->draw_text(Colors::WHITE, 10, 37, new Font5x8(), (char*)"PixelMaestro", 12);
}
